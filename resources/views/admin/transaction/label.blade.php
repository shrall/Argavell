        ...
        <div class="px-4 py-3">
            <div class="argavell-label">
                ...
                <div class="d-flex items-start justify-content-between mb-1 px-5 py-4">
                    <h1 style="font-size: 3rem">INV 190238120831823</h1>
                </div>
                <div class="row items-center px-5 py-4 mb-3">
                    <div class="col-3"></div>
                    <div class="col-4 d-flex flex-column">
                        <h1 style="font-size: 3rem">JNE</h1>
                        <h1 class="font-weight-bold" style="font-size: 3rem">OKE</h1>
                    </div>
                    ...
                    <div class="col-3 d-flex flex-column">
                        ...
                        <h1 class="font-weight-bold" style="font-size: 3rem">Rp 24.000</h1>
                    </div>
                </div>
