<div class="modal fade" id="sendModal{{ $transaction->id }}" tabindex="-1">
        ...
        <div class="modal-content">
            <form action="{{ route('admin.transaction.store') }}" method="post">
                ...
                <div class="modal-header border-0 d-block justify-content-center position-relative">
                    <h5 class="modal-title text-center text-argavell text-4xl font-weight-bold">Kirim Pesanan</h5>
                ...
                <div class="modal-body font-proxima-nova px-5">
                    <input type="hidden" name="transaction_id[]" id="input-transaction-send{{$transaction->id}}"
