...
@section('content')
    <div id="productShowcase" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="col-md-8 px-0">
            <div class="row">
                <div class="col-md-6 align-self-center px-5">
                    <h1 class="text-argavell font-bauer font-weight-bold">Our Story</h1>
    ...
    <div class="row w-100 landing-showcase-background text-center py-5"
    ...
    <div class="container py-5 text-center">
        ...
        <img src="{{ asset('images/find-us.png') }}" class="w-50 mb-5">
    </div>
@endsection
